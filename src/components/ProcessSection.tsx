...
const ProcessSection = () => {
  return <motion.section id="process" className="pt-16 pb-24 bg-white" initial={{
    opacity: 0
  }} whileInView={{
    opacity: 1
  }} viewport={{
    ...
    duration: 0.5
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-5xl lg:text-6xl font-heading font-bold text-dark-text mb-6 leading-tight">Our Simple Proces</h2>
